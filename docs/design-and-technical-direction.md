...
Status: research and a small interactive design concept are complete. Steps 01–08 now provide the
responsive playable implementation and an initial experience review; see the
